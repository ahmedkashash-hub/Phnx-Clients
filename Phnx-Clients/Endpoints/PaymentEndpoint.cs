    ...
    public class PaymentEndpoint : BaseEndpointGroup
    {
        ...
        public override void Map(WebApplication app)
        {
            app.MapGroup(GroupName)
                ...
                .WithDescription("Payment Management Endpoints")
                ...
                .Get("", async (ISender sender, HttpContext httpContext, [AsParameters] RequestHeaders requestHeaders, [AsParameters] GetUsersForAdminQuery query, CancellationToken cancellationToken) =>
                {
